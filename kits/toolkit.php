...
<div class="row">
    <div class="col">
        <h1>Tool Kits</h1>
        <h4>For all forms of glassworkers</h4>
    </div>
</div>
...
<div class="row border border-dark border-right-0 border-left-0">
    ...
    <div class="col-12 beige">
        ...
        <ul class="text-left">
            ...
            <li class="disc">
                Select the gas equipment kit needed to hook up your kit. <a href="/mobile/kits/gasEquipment.php">Click here</a>
            </li>
            <li class="disc">
                Choose the Tool Kit for what you want to build and is in your budget.
            </li>
            <li class="disc">
