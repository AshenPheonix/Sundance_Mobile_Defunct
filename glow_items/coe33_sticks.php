...
$title='Glow Glass COE33 - Sundance Art Glass';
$description='Glow Glass Glow in The Dark Rods and Frit. Compatible with Pyrex, Kimble, Northstar, Alchemy, Sunsilica, Simax, and Duran. Your Northern California, West Coast, and International source for artists working glass with a torch and a kiln - Flameworking Lampworking Glass Beadmaking Fusing Firing- Sundance Art Glass!';
$keywords='Glow Glass, Borostix, Pyrex, Kimble, Northstar, Alchemy, Sunsilica, Simax, Duran. Glass Flameworking, Glass Rod, Lampworking Glass, Borosilicate, Pipemaking, Pipe Making, Beadmaking, Sculpture, Sundance Art Glass';
...
<div class="row">
    <div class="col">
        <h1>Glow 33 Sticks</h1>
    </div>
</div>

<div class="row">
    <div class="col">
        <h3>Our Normal supplier has stopped, so we are working quickly to get a new supplier, this page will be updated as soon as that happens</h3>
    </div>
</div>
